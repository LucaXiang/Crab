-- 1. cloud_archived_orders: add order_key, tax, prev_hash, curr_hash
ALTER TABLE cloud_archived_orders ADD COLUMN order_key TEXT;
ALTER TABLE cloud_archived_orders ADD COLUMN tax REAL;
...
DROP INDEX IF EXISTS cloud_archived_orders_edge_server_id_source_id_key;
