export const es: Record<string, string> = {
	...
	'catalog.deleting': 'Eliminando...',
	'catalog.confirm_delete': '¿Seguro que quieres eliminar este elemento?',
	'catalog.confirm_delete_desc': 'Esta acción se enviará al terminal. No se puede deshacer.',
	'catalog.success': 'Operación completada.',
	'catalog.error': 'Error en la operación.',
	'catalog.edge_offline': 'El terminal está desconectado. Los cambios se enviarán cuando se reconecte.',
	'catalog.name': 'Nombre',
	'catalog.active': 'Activo',
	'catalog.inactive': 'Inactivo',
	'catalog.sort_order': 'Orden',
	...
	'products.spec_name': 'Nombre del spec',
	'products.spec_price': 'Precio',
	'products.add_spec': 'Añadir spec',
	'products.default_spec': 'Por defecto',
	...
	'attributes.empty': 'No hay atributos.',
	'attributes.new': 'Nuevo atributo',
	'attributes.edit': 'Editar atributo',
	'attributes.multi_select': 'Selección múltiple',
	'attributes.max_selections': 'Máx. selecciones',
	'attributes.options': 'Opciones',
	'attributes.add_option': 'Añadir opción',
	'attributes.option_name': 'Nombre',
	'attributes.option_price': 'Precio extra',

	// Price Rules
	'price_rules.title': 'Reglas de precio',
	'price_rules.empty': 'No hay reglas de precio.',
	'price_rules.new': 'Nueva regla',
	'price_rules.edit': 'Editar regla',
	'price_rules.display_name': 'Nombre visible',
	'price_rules.receipt_name': 'Nombre en ticket',
	'price_rules.rule_type': 'Tipo',
	'price_rules.discount': 'Descuento',
	'price_rules.surcharge': 'Recargo',
	'price_rules.scope': 'Ámbito',
	'price_rules.global': 'Global',
	'price_rules.by_category': 'Por categoría',
	'price_rules.by_tag': 'Por etiqueta',
	'price_rules.by_product': 'Por producto',
	'price_rules.adjustment': 'Ajuste',
	'price_rules.percentage': 'Porcentaje',
	'price_rules.fixed': 'Importe fijo',
	'price_rules.value': 'Valor',
	'price_rules.stackable': 'Acumulable',
	'price_rules.exclusive': 'Exclusiva',
	...
	'employees.password_hint': 'Dejar vacío para mantener',
	'employees.display_name': 'Nombre visible',
	'employees.role': 'Rol',

	'zones.title': 'Zonas',
	'zones.empty': 'No hay zonas.',
	'zones.new': 'Nueva zona',
	'zones.edit': 'Editar zona',
	'zones.description': 'Descripción',
	...
	'live.title': 'Pedidos en vivo',
	'live.active_orders': 'pedidos activos',
	'live.empty': 'No hay pedidos activos en este momento.',
	'live.edge_offline': 'Local desconectado',
	'live.ws_connecting': 'Conectando...',
	'live.ws_connected': 'En vivo',
	'live.ws_reconnecting': 'Reconectando...',
	'live.ws_disconnected': 'Desconectado',
	'live.retail': 'Venta directa',
	'live.paid': 'Pagado',
	'live.remaining': 'Pendiente',
	'live.more_items': 'artículos más',
	'live.detail': 'Detalle del pedido',
	'live.receipt_number': 'Recibo',
	'live.items': 'Artículos',
	'live.payments': 'Pagos',
	'live.price_breakdown': 'Desglose de precio',
	'live.subtotal': 'Subtotal',
	'live.discount': 'Descuento',
	'live.surcharge': 'Recargo',
	'live.comp': 'Cortesía',
	'live.tax': 'Impuesto',
	'live.total': 'Total',
	'live.note': 'Nota',
	'live.member': 'Miembro',
	'live.mg': 'Grupo marketing',
	'live.operator': 'Operador',
	'live.opened_at': 'Abierto',
	'live.updated_at': 'Actualizado',
	'live.no_payments': 'Sin pagos aún',
	'live.cancelled': 'Cancelado',
	'live.close': 'Cerrar',
	'live.dine_in': 'En sala',
	'live.takeout': 'Para llevar',
	'live.comped': 'Cortesía',
	'live.events': 'Eventos',
	'live.ev.table_opened': 'Mesa abierta',
	'live.ev.order_completed': 'Pedido completado',
	'live.ev.order_voided': 'Pedido anulado',
	'live.ev.items_added': 'Artículos añadidos',
	'live.ev.item_modified': 'Artículo modificado',
	'live.ev.item_removed': 'Artículo eliminado',
	'live.ev.item_comped': 'Cortesía aplicada',
	'live.ev.item_uncomped': 'Cortesía retirada',
	'live.ev.payment_added': 'Pago añadido',
	'live.ev.payment_cancelled': 'Pago cancelado',
	'live.ev.item_split': 'División por artículo',
	'live.ev.amount_split': 'División por importe',
	'live.ev.aa_split_started': 'División AA iniciada',
	'live.ev.aa_split_paid': 'División AA pagada',
	'live.ev.aa_split_cancelled': 'División AA cancelada',
	'live.ev.order_moved': 'Pedido trasladado',
	'live.ev.order_moved_out': 'Trasladado fuera',
	'live.ev.order_merged': 'Pedido fusionado',
	'live.ev.order_merged_out': 'Fusionado fuera',
	'live.ev.table_reassigned': 'Mesa reasignada',
	'live.ev.order_info_updated': 'Info actualizada',
	'live.ev.rule_skip_toggled': 'Regla modificada',
	'live.ev.order_discount_applied': 'Descuento aplicado',
	'live.ev.order_surcharge_applied': 'Recargo aplicado',
	'live.ev.order_note_added': 'Nota añadida',
	'live.ev.member_linked': 'Miembro vinculado',
	'live.ev.member_unlinked': 'Miembro desvinculado',
	'live.ev.stamp_redeemed': 'Sello canjeado',
	'live.ev.stamp_redemption_cancelled': 'Sello cancelado',
