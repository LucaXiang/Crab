...
export type DefaultLabelTemplate = Omit<LabelTemplate, 'id' | 'created_at' | 'updated_at'>;

export function getDefaultLabelTemplates(currencySymbol: string): DefaultLabelTemplate[] {
  return [
    {
