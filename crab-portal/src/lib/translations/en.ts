export const en: Record<string, string> = {
	...
	'hero.badge': 'Works offline · Verifactu included · Never miss a sale',
	'hero.title_pre': 'The modern ',
	'hero.title_highlight': 'POS',
	'hero.title_post': ' for hospitality',
	'hero.subtitle':
		'Works without internet, Verifactu-compliant from day one, and every operation is fully traceable. From ordering to checkout, everything just works.',
	...
	'features.subtitle':
		'Built for the demands of real hospitality operations — reliable, fast, and Verifactu-ready',
	...
	'features.verifactu.title': 'Verifactu Included',
	'features.verifactu.desc':
		'Anti-fraud compliance from day one. Verifiable invoicing, immutable records, and digital signatures — no extra modules or hidden costs.',
	...
	'features.audit.title': 'Anti-Fraud Audit Trail',
	'features.audit.desc':
		'Every operation is recorded with full traceability. Immutable history — no data can be deleted or tampered with. Total control over your business.',
	...
	'showcase.title': 'Your restaurant, fully under control',
	'showcase.subtitle': 'Every feature designed to keep service flowing smoothly — from first order to end-of-day close.',
	'showcase.ordering.title': 'Orders in seconds',
	'showcase.ordering.desc': 'Visual menu with categories, quick search, and numeric shortcuts. One tap to add, no extra screens.',
	'showcase.payment.title': 'Accept any payment',
	'showcase.payment.desc': 'Cash, card, split bill, discounts, comps, surcharges — all from a single screen.',
	'showcase.split.title': 'Split bills effortlessly',
	'showcase.split.desc': 'Select each guest\'s items and charge separately. Fast and error-free.',
	'showcase.audit.title': 'Complete anti-fraud log',
	'showcase.audit.desc': 'Every operation recorded with timestamp, operator, and cryptographic hash. Impossible to delete or alter.',
	'showcase.loyalty.title': 'Built-in loyalty',
	'showcase.loyalty.desc': 'Stamp cards, VIP discounts, and automatic pricing rules. Your customers keep coming back.',
	...
	'faq.subtitle': 'What restaurant owners ask most before switching their POS',
	'faq.anxiety_title': 'Did you know your POS must comply with Verifactu by 2027?',
	'faq.anxiety_desc': 'Spanish anti-fraud regulations require all invoicing systems to generate immutable, digitally signed records. Non-compliance can result in fines of up to \u20AC50,000.',
	...
	'faq.q2': 'Is RedCoral Verifactu-compliant?',
	'faq.a2': 'Yes. RedCoral includes Verifactu compliance out of the box, with no extra modules. All invoices are digitally signed and records are immutable, meeting current anti-fraud regulations. You will be ready well before the 2027 deadline.',
	'faq.q3': 'How does RedCoral prevent internal fraud?',
	'faq.a3': 'Every operation — sales, voids, discounts, price changes — is recorded immutably with a timestamp and user ID. History cannot be deleted or modified. You get full visibility into what happens in your business.',
	'faq.q4': 'Do I need special hardware?',
	'faq.a4': "No. RedCoral runs on any PC or laptop with Windows. It also works with most thermal receipt printers — just plug in and go.",
	'faq.q5': 'Can I change plans at any time?',
	'faq.a5': 'Yes. You can upgrade or downgrade at any time. Charges are prorated. Upgrades take effect immediately; downgrades apply at the end of the current billing cycle.',
	...
	'footer.tagline': 'Offline-first POS for hospitality — Verifactu-compliant, secure, and reliable.',
	...
	'auth.label_password_confirm': 'Confirm Password',
