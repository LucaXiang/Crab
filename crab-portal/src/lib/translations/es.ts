export const es: Record<string, string> = {
	...
	'hero.badge': 'Funciona sin internet · Verifactu incluido · Nunca pierdas una venta',
	'hero.title_pre': 'El ',
	'hero.title_highlight': 'TPV',
	'hero.title_post': ' moderno para hostelería',
	'hero.subtitle':
		'Funciona sin internet, cumple con Verifactu desde el primer día y registra cada operación con trazabilidad total. Del pedido al cobro, todo simplemente funciona.',
	...
	'features.subtitle':
		'Diseñado para las exigencias del día a día en hostelería — fiable, rápido y preparado para Verifactu',
	...
	'features.verifactu.title': 'Verifactu Incluido',
	'features.verifactu.desc':
		'Cumple con la normativa antifraude desde el primer día. Facturación verificable, registros inalterables y firma digital — sin módulos extra ni costes adicionales.',
	...
	'features.audit.title': 'Registro Antifraude',
	'features.audit.desc':
		'Cada operación queda registrada con trazabilidad completa. Historial inmutable, sin posibilidad de borrar o alterar datos. Control total sobre tu negocio.',
	...
	'showcase.label': 'Producto',
	'showcase.title': 'Tu restaurante, bajo control total',
	'showcase.subtitle': 'Cada función diseñada para que el servicio fluya sin fricciones — desde el primer pedido hasta el cierre de caja.',
	'showcase.ordering.title': 'Pedidos en segundos',
	'showcase.ordering.desc': 'Carta visual con categorías, búsqueda rápida y atajos numéricos. Un toque para añadir, sin pantallas intermedias.',
	'showcase.payment.title': 'Cobra como quieras',
	'showcase.payment.desc': 'Efectivo, tarjeta, cuenta dividida, descuentos, invitaciones, recargos — todo desde una sola pantalla.',
	'showcase.split.title': 'Divide la cuenta sin líos',
	'showcase.split.desc': 'Selecciona los platos de cada comensal y cobra por separado. Rápido y sin errores.',
	'showcase.audit.title': 'Registro antifraude total',
	'showcase.audit.desc': 'Cada operación queda grabada con marca de tiempo, operador y hash criptográfico. Imposible de borrar o alterar.',
	'showcase.loyalty.title': 'Fidelización integrada',
	'showcase.loyalty.desc': 'Tarjetas de sellos, descuentos VIP y reglas de precios automáticas. Tus clientes vuelven.',
	...
	'faq.subtitle': 'Lo que más preguntan los hosteleros antes de cambiar de TPV',
	'faq.anxiety_title': '¿Sabías que a partir de 2027 tu TPV debe cumplir con Verifactu?',
	'faq.anxiety_desc': 'La normativa antifraude obliga a que todos los sistemas de facturación generen registros inalterables y firmados digitalmente. El incumplimiento puede suponer multas de hasta 50.000 €.',
	...
	'faq.q2': '¿RedCoral cumple con Verifactu?',
	'faq.a2': 'Sí. RedCoral incluye cumplimiento Verifactu de serie, sin módulos adicionales. Todas las facturas llevan firma digital y los registros son inalterables, cumpliendo con la normativa antifraude vigente. Estarás preparado antes de la fecha límite de 2027.',
	'faq.q3': '¿Cómo evita RedCoral el fraude interno?',
	'faq.a3': 'Cada operación — ventas, anulaciones, descuentos, cambios de precio — queda registrada de forma inmutable con marca de tiempo y usuario. No se puede borrar ni modificar el historial. Tendrás visibilidad total sobre lo que ocurre en tu negocio.',
	'faq.q4': '¿Necesito hardware especial?',
	'faq.a4': 'No. RedCoral funciona en cualquier PC o portátil con Windows. También es compatible con la mayoría de impresoras térmicas de tickets — solo conecta y listo.',
	'faq.q5': '¿Puedo cambiar de plan en cualquier momento?',
	'faq.a5': 'Sí. Puedes actualizar o reducir tu plan en cualquier momento. Los cargos se ajustan proporcionalmente. La actualización se aplica de inmediato; la reducción entra en vigor al final del ciclo de facturación actual.',
	...
	'footer.tagline': 'TPV offline-first para hostelería — Verifactu incluido, seguro y fiable.',
	...
	'auth.label_password_confirm': 'Confirmar contraseña',
