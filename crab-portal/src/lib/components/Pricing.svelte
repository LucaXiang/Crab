...
<section id="pricing" class="py-24 md:py-32 bg-slate-50">
	<div class="max-w-6xl mx-auto px-6">
		...
		<div class="grid md:grid-cols-3 gap-5 max-w-5xl mx-auto">
			...
			<!-- Professional -->
			<div class="bg-white rounded-2xl p-7 flex flex-col relative ring-2 ring-coral-500 shadow-2xl shadow-coral-500/10 md:scale-105 z-10 transform transition-transform duration-300">
